...
public class DatabaseHandler extends SQLiteOpenHelper{
    ...
    // Contacts table name
    private static final String TABLE_CONTACTS = "participant";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_CONTACTS + "("
                + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + NAME + " TEXT NOT NULL," + WEIGHT + " TEXT NOT NULL,"+ AGE + " TEXT NOT NULL);";
    ...
    void addContact(Contact contact) {
        ...
        values.put(WEIGHT, contact.getWeight());// Contact Weight
        values.put(AGE, contact.getAge());//Contact Age
    ...
    Contact getContact(int id) {
        ...
        Cursor cursor = db.query(TABLE_CONTACTS, new String[]{KEY_ID, NAME,}, KEY_ID + "=?", new String[]{String.valueOf(id)}, null, null, null, null);
        if (cursor != null)
            cursor.moveToFirst();
    ...
    public Cursor readEntry(){
        String[] allColumns = new String[] {KEY_ID, NAME, WEIGHT, AGE};
        SQLiteDatabase db = this.getWritableDatabase();
